    ...
    public void requestData(VideoExploreQueryEnum query, DataQueryCallback callback) {
        mMovies = Arrays.asList(
                new MovieData("圆梦巨人",
                        ...
                        7080000L,
                        "http://free-video-bucket.oss-cn-shanghai.aliyuncs.com/yuanmengjuren.mp4"),
                new MovieData("会计刺客",
                        "http://tu.23juqing.com/d/file/html/gndy/dyzz/2016-12-09/b5fc707407ceead673d63bcd76be4559.jpg",
                        5700000L,
                        "http://free-video-bucket.oss-cn-shanghai.aliyuncs.com/BloodMoon_GettyRM_495644264_768_ZH-CN.mp4"),
                new MovieData("单身日记",
