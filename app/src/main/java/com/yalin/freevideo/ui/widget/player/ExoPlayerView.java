package com.yalin.freevideo.ui.widget.player;
...
public class ExoPlayerView extends FrameLayout {
    ...
    private boolean forceHideController = false;
    ...
    public ExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        controller = (PlaybackControlView) findViewById(com.google.android.exoplayer2.R.id.control);
        controller.hide();
    ...
    public void forceHideController(boolean forceHide) {
        forceHideController = forceHide;
        if (forceHide && controller.isVisible()) {
            controller.hide();
        }
    }
    ...
    private void maybeShowController(boolean isForced) {
        if (!useController || player == null || forceHideController) {
            return;
        }
